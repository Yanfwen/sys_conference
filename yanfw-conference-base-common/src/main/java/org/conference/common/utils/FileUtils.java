...
import org.conference.common.constant.FileConstant;
...
public class FileUtils {
     ...
     * @return 文件行数
     */
    public final static int fileCountLines(File file) {
   ...
   /**
     ...
     * @return 包含所有行的list
     */
    public final static List<String> fileCountLines(File file, String encoding) {
        List<String> list = new ArrayList<>();
        try (
     ...
     * @return 包含制定行的list
     */
    public final static List<String> lineDate(File file, int lines) {
        List<String> list = new ArrayList<>();
     ...
     * @return 包含制定行的list
     */
    public final static List<String> lineDate(File file, int lines, String encoding) {
        List<String> list = new ArrayList<>();
        try (
                BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(file), encoding))
        ) {
    ...
    public final static boolean appendLine(File file, String str) {
        try (
            ...
            randomFile.writeBytes(PropertiesUtils.key(FileConstant.SYS_FILE_SEPARATOR) + str);
            return true;
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public final static String getFileTypeByStream(byte[] b) {
        ...
        Iterator<Map.Entry<String, String>> entryiterator = FileConstant.FILE_TYPE_MAP.entrySet().iterator();
    ...
    public final static boolean copy(File file, String targetFile) {
        try (
            ...
            //设定缓冲区
            ByteBuffer buffer = ByteBuffer.allocate(FileConstant.BUFFER_SIZE);
