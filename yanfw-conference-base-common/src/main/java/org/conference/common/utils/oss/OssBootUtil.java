package org.conference.common.utils.oss;
...
import org.conference.common.utils.CommonUtils;
import org.conference.common.utils.FileUtils;
...
public class OssBootUtil {
    ...
    public static String upload(MultipartFile file, String fileDir, String customBucket) {
        ...
        if (CommonUtils.isNotEmpty(customBucket)) {
        ...
        try {
            ...
            if (CommonUtils.isNotEmpty(staticDomain) && staticDomain.toLowerCase().startsWith("http")) {
...
//            ossClient.setBucketAcl(newBucket, CannedAccessControlList.PublicRead);
    ...
    public static void deleteUrl(String url, String bucket) {
        String newBucket = bucketName;
        if (CommonUtils.isNotEmpty(bucket)) {
            newBucket = bucket;
        }
        String bucketUrl = "";
        if (CommonUtils.isNotEmpty(staticDomain) && staticDomain.toLowerCase().startsWith("http")) {
