package org.conference.common.utils.encrpt;



import org.conference.common.constant.CodeConstant;
...
public final class Base64 {
    ...
    public final static byte[] encodeToByte(String s) {
        try {
            return encodeToByte(s.getBytes(CodeConstant.UTF_8), false);
    ...
    public final static byte[] encodeToByte(String s, boolean lineSep) {
        try {
            return encodeToByte(s.getBytes(CodeConstant.UTF_8), lineSep);
        } catch (UnsupportedEncodingException ignore) {
            return new byte[]{};
        }
    }
    ...
    public final static String decodeToString(byte[] arr) {
        try {
            return new String(decode(arr), CodeConstant.UTF_8);
        } catch (UnsupportedEncodingException ignore) {
            return null;
        }
    }
    ...
    public final static String encodeToString(String s) {
        try {
            return new String(encodeToChar(s.getBytes(CodeConstant.UTF_8), false));
        } catch (UnsupportedEncodingException ignore) {
            return null;
        }
    }
    ...
    public final static String encodeToString(String s, boolean lineSep) {
        try {
            return new String(encodeToChar(s.getBytes(CodeConstant.UTF_8), lineSep));
        } catch (UnsupportedEncodingException ignore) {
            return null;
        }
    }
    ...
    public final static String decodeToString(String s) {
        try {
            return new String(decode(s), CodeConstant.UTF_8);
        } catch (UnsupportedEncodingException ignore) {
            return null;
        }
    }
